...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/admin/settings/basic/': RouteRecordInfo<'/admin/settings/basic/', '/admin/settings/basic', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/admin/settings/basic/index.vue': {
      routes: '/admin/settings/basic/'
      views: never
    }
