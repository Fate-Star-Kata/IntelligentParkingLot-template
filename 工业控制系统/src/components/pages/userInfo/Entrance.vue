<template>
    <div class="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-indigo-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"
        ...
        <div class="relative w-full h-full flex gap-6 p-6">
            ...
            <div class="h-full w-1/2">
                <div
                    class="w-full h-full flex flex-col p-6 bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700/20 hover:shadow-3xl transition-all duration-500">
                    <!-- 标题和提示 -->
                    <div class="mb-8 text-center relative">
                        <!-- 装饰性图标 -->
                        <div
                            class="absolute -top-4 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full">
                        </div>

                        <div class="flex items-center justify-center mb-4">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center mr-4 shadow-lg">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-3">
                            <div
                                class="w-5 h-5 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full mr-2 flex items-center justify-center">
                        ...
                        <div class="relative">
                            <select v-model="selectedDeviceId" @change="switchCamera"
                                class="w-full px-4 py-3 bg-gray-700/70 backdrop-blur-sm border-2 border-gray-600/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 appearance-none cursor-pointer hover:border-blue-400/50 text-white">
                    ...
                    <!-- 视频显示区域 -->
                    <div
                        class="flex-1 relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-inner border-2 border-gray-700/50">
                        <video ref="videoRef" autoplay playsinline muted class="w-full h-full object-cover"
                            v-show="isVideoActive"></video>



                        <!-- 角落装饰 -->
                        <div class="absolute top-4 left-4 w-6 h-6 border-l-2 border-t-2 border-blue-400 opacity-60"
                            v-show="isVideoActive"></div>
                        <div class="absolute top-4 right-4 w-6 h-6 border-r-2 border-t-2 border-blue-400 opacity-60"
                            v-show="isVideoActive"></div>
                        <div class="absolute bottom-4 left-4 w-6 h-6 border-l-2 border-b-2 border-blue-400 opacity-60"
                            v-show="isVideoActive"></div>
                        <div class="absolute bottom-4 right-4 w-6 h-6 border-r-2 border-b-2 border-blue-400 opacity-60"
                            v-show="isVideoActive"></div>
                        ...
                        <div v-if="isLoading"
                            ...
                            <div class="text-white text-center">
                                <div class="relative mb-6">
                                    <div
                                        class="animate-spin rounded-full h-16 w-16 border-4 border-white/20 border-t-white mx-auto">
                                    </div>
                                    <div class="absolute inset-0 rounded-full border-4 border-transparent border-t-blue-400 animate-spin"
                        ...
                        <!-- 错误状态 -->
                        <div v-if="error"
                            class="absolute inset-0 bg-gradient-to-br from-red-900/80 to-orange-900/80 flex items-center justify-center">
                            <div class="text-center text-red-600 max-w-md mx-auto p-6">
                                <div
                                    class="w-20 h-20 bg-red-800/50 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <!-- 错误信息显示 -->
                                <div
                                    class="text-left text-sm text-red-300 mb-6 bg-red-900/50 p-4 rounded-lg border border-red-700/50">
                                    <div v-if="error.includes('\n')" class="space-y-2">
                                        <div v-for="(line, index) in error.split('\n')" :key="index"
                                            ...
                                            <span v-else class="inline-block w-full text-left"
                                                :class="index === 0 ? 'font-semibold text-red-700' : ''">{{ line
                                                }}</span>
                                        </div>
                                    </div>
                        ...
                        <div v-if="!isVideoActive && !isLoading && !error"
                            class="absolute inset-0 flex items-center justify-center bg-gray-800">
                            <p class="text-gray-300">请选择摄像头</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- 右侧区域 -->
            <div class="h-full w-1/2">
                <div class="w-full h-full flex flex-col p-5 bg-gray-800/80 rounded-lg shadow-md">
                    <!-- 上部分：车牌识别结果和分配车位 (1/3) -->
                    <div class="h-1/3 flex gap-4 mb-4">
                        <!-- 左侧卡片：车牌识别结果 -->
                        <div
                            class="w-1/2 bg-gradient-to-br from-blue-900/50 to-indigo-900/50 rounded-xl shadow-lg p-3 border border-blue-700/50 overflow-hidden">
                            <div class="flex items-center mb-2">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center mr-2 transition-all duration-300"
                                    :class="isDetecting ? 'bg-yellow-500 animate-pulse' : licensePlate ? 'bg-green-500' : 'bg-blue-500'">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path v-if="isDetecting" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        <path v-else-if="licensePlate" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <!-- 车牌号码显示 -->
                            <div
                                class="bg-gray-700/80 rounded-lg p-2 mb-2 shadow-inner border-2 border-dashed border-blue-500/50">
                                <div class="text-center">
                                    <div class="text-xl font-bold text-blue-300 tracking-wider font-mono">
                                        {{ licensePlate || '等待识别...' }}
                                    </div>
                                    <div class="text-xs text-gray-400">License Plate Number</div>
                                </div>
                            </div>

                            <!-- 详细信息 -->
                            <div class="space-y-1">
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">识别可信度</span>
                                ...
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">车辆类型</span>
                                ...
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">进场时间</span>
                        ...
                        <!-- 右侧卡片：分配车位 -->
                        <div class="w-1/2 rounded-xl shadow-lg p-3 border overflow-hidden transition-all duration-300"
                            :class="assignedSpot ? 'bg-gradient-to-br from-green-900/50 to-emerald-900/50 border-green-700/50' : 'bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50'">
                            <div class="flex items-center mb-2">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center mr-2 transition-all duration-300"
                                    :class="assignedSpot ? 'bg-green-500' : 'bg-gray-400'">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path v-if="assignedSpot" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"
                                ...
                                <h3 class="text-lg font-bold transition-all duration-300"
                                    :class="assignedSpot ? 'text-gray-200' : 'text-gray-400'">
                            ...
                            <!-- 车位号码显示 -->
                            <div
                                class="bg-gray-700/80 rounded-lg p-3 mb-2 shadow-inner border-2 border-dashed border-green-500/50">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-green-300 tracking-wider font-mono">
                                        {{ assignedSpot || '--' }}
                                    </div>
                                    <div class="text-xs text-gray-400">Assigned Parking Space</div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">距离入口</span>
                                    <div class="flex items-center">
                                ...
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">预计步行时间</span>
                                    <span
                                ...
                                <div class="flex items-center justify-between bg-gray-700/60 rounded-lg p-2">
                                    <span class="text-xs font-medium text-gray-300">车位状态</span>
                                    <div class="flex items-center">
                                        <div class="w-2 h-2 rounded-full mr-1"
                                            :class="spotStatus ? 'bg-green-500 animate-pulse' : 'bg-gray-400'"></div>
                    ...
                    <!-- 下部分：停车场缩略图 (2/3) -->
                    <div class="flex-1 bg-gray-800/50 rounded-lg p-2 overflow-hidden">
                        <h3 class="text-sm font-bold text-gray-200 mb-2">停车场布局图</h3>
                        <div class="w-full h-full bg-gray-900/50 rounded-lg relative overflow-hidden p-2">
                            <!-- 停车场缩略图内容 - 与admin dashboard保持一致 -->
                            <div class="parking-layout-thumbnail h-full">
                                <!-- 入口标识 -->
                                <div
                                    class="absolute bottom-1 left-1/2 transform -translate-x-1/2 text-xs font-bold text-green-300 bg-green-900/50 px-2 py-1 rounded">
                                    入口
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 h-full pt-2 pb-6">
                                    ...
                                    <div class="area-section">
                                        <h4 class="text-xs font-medium text-gray-300 mb-2 text-center">A区</h4>
                                        <div class="flex justify-center gap-1 flex-wrap">
                                            <div v-for="i in 5" :key="'A' + i" class="parking-space-mini"
                                    ...
                                    <!-- B区 -->
                                    <div class="area-section">
                                        <h4 class="text-xs font-medium text-gray-300 mb-2 text-center">B区</h4>
                                        <div class="flex justify-center gap-1 flex-wrap">
                                            <div v-for="i in 5" :key="'B' + i" class="parking-space-mini"
                                    ...
                                    <!-- C区 -->
                                    <div class="area-section">
                                        <h4 class="text-xs font-medium text-gray-300 mb-2 text-center">C区</h4>
                                        <div class="flex justify-center gap-1 flex-wrap">
                                            <div v-for="i in 5" :key="'C' + i" class="parking-space-mini"
                                    ...
                                    <!-- D区 -->
                                    <div class="area-section">
                                        <h4 class="text-xs font-medium text-gray-300 mb-2 text-center">D区</h4>
                                        <div class="flex justify-center gap-1 flex-wrap">
                                            <div v-for="i in 5" :key="'D' + i" class="parking-space-mini"
